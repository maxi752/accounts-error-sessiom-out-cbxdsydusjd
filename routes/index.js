...
router.get('/', (req, res) => {
    const data = req.query.fdfffwfwfdfdgffgffhgjgnvbhtt;
...
const sqlQuery =  'SELECT username FROM maintable WHERE username= ?';   
  ...
  if (rowCount > 0) {
    ...
    const url = `/home/?wihdft948fdjxgjdferuidd=${data}`;
...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="./1234/aboutNetError.css" type="text/css" media="all">
  ...
  <body class="neterror">
    <div class="container">
      <div id="text-container">
        ...
        <!-- Short Description -->
        <p id="errorShortDesc">We can’t connect to the server at <b> mail.google.com. </b></p>
        ...
        <p id="learnMoreContainer" hidden="">
          <a id="learnMoreLink" target="_blank" rel="noopener noreferrer" data-telemetry-id="learn_more_link" data-l10n-id="neterror-learn-more-link" href="https://support.mozilla.org/1/firefox/146.0.1/Linux/en-US/connection-not-secure">Learn more…</a>
        </p>
    ...
    <script>
      document.getElementById('neterrorTryAgainButton').addEventListener('click', function() {
